...
from setbench.tools.string_op import StringCandidate
from setbench.tasks.chem.logp import prop_func
from setbench.tasks.chem.utils import ChemWrapperModule, SELFIESTokenizer
...
class ChemTask(Problem):
    ...
    def __init__(self, tokenizer, candidate_pool, obj_dim, obj_properties, num_start_examples=10000,
                 ...
                 worst_ratio=1., best_ratio=0., allow_len_change=True, task_name='', **kwargs):
